    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Akun Pengguna Pembukuan</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{url('admin/akunpembukuan/'.$user1->id.'/update')}}" enctype="multipart/form-data">
