    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading">Buat Akun Pengguna Pajak</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('akunkegiatan.store')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
