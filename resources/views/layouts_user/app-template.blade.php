...
<html>
  <head>
    ...
    <!-- Wizard -->
    <link rel="stylesheet" type="text/css" href="{{(asset("/assets/wizard/vue-form-wizard.min.css"))}}"/>
    <!-- Ionicons -->
  ...
  <body class="hold-transition skin-purple sidebar-mini">
    ...
    <!-- Wizard -->
    <link href="{{ asset("/assets/themify_icons/themify-icons.css")}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="https://unpkg.com/vue-form-wizard/dist/vue-form-wizard.min.css">
    <script src="https://cdn.jsdelivr.net/npm/vue@2.5.17/dist/vue.js"></script>
    <script src="{{ asset("/assets/wizard/vue-form-wizard.js")}}"></script>
    <!-- AdminLTE App -->
